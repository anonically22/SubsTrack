...
const Rewards = () => {
    return (
        <div className="flex flex-col gap-8">
            <PageHeader
                title="Rewards"
                description="Exclusive offers and cashback on your subscriptions."
            />
            ...
            <div>
                ...
                <div className="flex gap-4 overflow-x-auto pb-4">
                    {['All', 'Entertainment', 'Music', 'Productivity', 'Food', 'Utilities'].map((cat, i) => (
                        <button key={i} className={`px-6 py-2 rounded-full border transition-colors whitespace-nowrap ${i === 0 ? 'bg-primary text-white border-primary' : 'border-border hover:bg-input'}`}>
                            {cat}
                        </button>
                    ))}
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                    ...
                    <div key={i} className="card group hover:border-primary/50 transition-all">
                        ...
                        <div className="flex justify-between items-center bg-input p-3 rounded-lg border border-border">
